    ...
    return (
        <div className="px-8 py-2 max-w-[1200px] mx-auto space-y-8 pb-12">
            ...
            <div className="admin-card overflow-hidden">
                ...
                <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-1.5">
                        ...
                        <input type="text" placeholder="Dr. John Doe" className="admin-input" />
                    </div>
                    <div className="space-y-1.5">
                        <label className="admin-label">Email Address</label>
                        <input type="email" placeholder="john.doe@hospital.com" className="admin-input" />
                    </div>
                    <div className="space-y-1.5">
                        ...
                        <div className="relative flex items-center">
                            ...
                            <input type="text" placeholder="+91 98765 43210" className="admin-input pl-12" />
                        </div>
                    </div>
                    <div className="space-y-1.5">
            ...
            <div className="admin-card overflow-hidden">
                ...
                <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <input type="text" placeholder="MBBS, MD, MS (Cardiology)" className="admin-input" />
                    </div>
                    <div className="space-y-1.5">
                        <label className="admin-label">NMC Registration Number</label>
                        <input type="text" placeholder="NMC-12345-ABC" className="admin-input" />
                    </div>
                    <div className="space-y-1.5">
                        <label className="admin-label">Experience (Years)</label>
                        <input type="number" placeholder="5" className="admin-input" />
                    </div>
                </div>
            </div>
            ...
            <div className="flex justify-end gap-4 p-4">
                <button className="px-8 py-3 admin-button-secondary text-sm">
                    Cancel
                </button>
                <button className="px-6 py-3 admin-button-primary flex items-center gap-3">
                    <Save size={18} />
                    Save Doctor
                </button>
            </div>
